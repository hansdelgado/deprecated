 ...
 */
package pe.edu.cibertec.gch.filters.curso;

import pe.edu.cibertec.gch.filters.*;
 ...
 * @author JAVA_MJ
 */
@WebFilter(filterName = "CursoUpdateValidadorFilter", urlPatterns = {"/actualizarCurso"})
public class CursoUpdateValidadorFilter implements Filter {
    ...
    public CursoUpdateValidadorFilter() {
    }    
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (errores.size() > 0) {
            ...
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/view/curso/modifica.jsp");
